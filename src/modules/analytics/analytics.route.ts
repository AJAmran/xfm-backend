...
router.get("/branches", authGuard(Role.SUPER_ADMIN, Role.ADMIN, Role.COO, Role.MD), validateSchema({ query: analyticsQuerySchema }), analyticsController.branches);
...
router.get("/dashboard", validateSchema({ query: analyticsQuerySchema }), analyticsController.dashboardSummary);
